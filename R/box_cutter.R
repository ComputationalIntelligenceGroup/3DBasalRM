...
#'
#' @return a list where the first element is the JSON plain text of the neuron and the second is a list of the elements in the neuron
#'
#' @export
box_cutter<-function(json_info, mins=c(Inf, Inf, Inf), maxs=c(Inf, Inf, Inf))
{
  ...
  return(list(plain=neuron_cuts,data=neuron))
}
